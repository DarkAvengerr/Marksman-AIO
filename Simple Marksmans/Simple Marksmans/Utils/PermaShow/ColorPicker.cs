...
namespace Simple_Marksmans.Utils.PermaShow
{
    public sealed class ColorPicker : ValueBase<Color>
    {
        ...
        internal EloBuddy.SDK.Rendering.Text RedText { get; set; }
        internal EloBuddy.SDK.Rendering.Text GreenText { get; set; }
        internal EloBuddy.SDK.Rendering.Text BlueText { get; set; }
        internal EloBuddy.SDK.Rendering.Text AlphaText { get; set; }
        internal EloBuddy.SDK.Rendering.Text DisplayNameText { get; set; }
        ...
        protected override void OnThemeChange()
        {
            ...
            RedText = new EloBuddy.SDK.Rendering.Text("Red", DefaultFont) { Color = DefaultColorGreen };
            GreenText = new EloBuddy.SDK.Rendering.Text("Green", DefaultFont) { Color = DefaultColorGreen };
            BlueText = new EloBuddy.SDK.Rendering.Text("Blue", DefaultFont) { Color = DefaultColorGreen };
            AlphaText = new EloBuddy.SDK.Rendering.Text("Alpha", DefaultFont) { Color = DefaultColorGreen };
            DisplayNameText = new EloBuddy.SDK.Rendering.Text(DisplayName, DisplayNameTextFont) { Color = DefaultColorGold };
